...
class AllOne {
  ...
  public static void main(String[] args) {
    ...
    allOne.inc("hello");
    allOne.inc("hello");
    System.out.println("Max Key: " + allOne.getMaxKey()); // Expected: "hello"
    System.out.println("Min Key: " + allOne.getMinKey()); // Expected: "hello"

    allOne.inc("leet");
    System.out.println("Max Key: " + allOne.getMaxKey()); // Expected: "hello"
    System.out.println("Min Key: " + allOne.getMinKey()); // Expected: "leet"

    allOne.inc("leet");
    allOne.inc("leet");
    System.out.println("Max Key: " + allOne.getMaxKey()); // Expected: "leet"
    System.out.println("Min Key: " + allOne.getMinKey()); // Expected: "hello"
